...
module.exports = React.createClass({
    ...
    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
        if (nextProps.selectedItem !== this.state.selectedItem) {
            this.updateSizes();
            // Disabled change selected item when receive new props
            // this.setState({
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    this.props.enableTouch ? React.createElement(
                        Swipe,
                        _extends({ tagName: 'ul' }, swiperProps, { allowMouseEvents: this.props.emulateTouch }),
                        this.renderItems()
                    ) : React.createElement(
                        'ul',
                        _extends({}, swiperProps, { allowMouseEvents: this.props.emulateTouch }),
                        this.renderItems()
                    )
                ),
